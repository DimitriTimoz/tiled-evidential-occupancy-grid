...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'evidential_grid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alix_anneraud/Git/INSA/tiled_evidential_occupancy_grid_maps/src/evidential_grid/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/alix_anneraud/Git/INSA/tiled_evidential_occupancy_grid_maps/devel/lib;/home/alix_anneraud/Git/INSA/tiled_evidential_occupancy_grid_maps/devel/lib;/opt/ros/melodic/lib)
